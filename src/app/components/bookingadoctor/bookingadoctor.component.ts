...
@Component({
  selector: 'app-bookingadoctor',
  templateUrl: './bookingadoctor.component.html',
  styleUrls: ['./bookingadoctor.component.scss']
})
export class BookingadoctorComponent implements OnInit {
  department:string;
  address:string;
  isLoaded:boolean;
  doctors:string;
